...
public class CustomProgress extends Dialog {
	 ...
	 *            按下返回键监�?	 * @return
	 */
	public static CustomProgress init(Context context, CharSequence message, boolean cancelable, OnCancelListener cancelListener) {
		...
		// 监听返回键处�?		dialog.setOnCancelListener(cancelListener);
		// 设置居中
